  ...
  return (
    <div className="max-w-3xl mx-auto p-6 text-gray-800">
      ...
      <ul className="list-disc pl-6 space-y-1">
        <li>Personal details such as name, address, email ID, and phone number.</li>
        <li>Order-related information including delivery address and payment details.</li>
        <li>Device information, IP address, browser type, and cookies.</li>
      </ul>
      ...
      <ul className="list-disc pl-6 space-y-1">
        ...
        <li>To send order notifications, updates, or promotional messages (only if opted-in).</li>
      ...
      <p className="mb-4">We do not sell your personal information. We may share information only with:</p>
      <ul className="list-disc pl-6 space-y-1">
